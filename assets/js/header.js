...
const profile = `${href}/Html_Pages/profile.html`;
const sign_up = `${href}/Html_Pages/signup.html`;
const login = `${href}/Html_Pages/login.html`;
const tasklist = `${href}/Html_Pages/listTask.html`;
